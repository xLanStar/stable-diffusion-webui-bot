...
export const getLastParameterMessage = async (
...
export const getRequestInput = async (
  ...
  return {
    ...
    parameter: {
      ...
      init_images:
        method === Methods.img2img && fetchImage && processImageUrl
          ? [
              await axios
                .get(processImageUrl, { responseType: "arraybuffer" })
                .then(
                  ({ data }) =>
