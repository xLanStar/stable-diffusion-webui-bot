...
const RequestSetting2Modal: IRequestSetting2Modal = {
  ...
  build: (locale: LocaleData, parameter: Parameter) => {
    const widthText = new TextInputBuilder({
      custom_id: "width",
      label: `${locale.width}${f(locale.default, {
        value: stableDiffusion._.DefaultWidth,
      })}${f(locale.range, {
        a: stableDiffusion._.MinWidth,
        b: stableDiffusion._.MaxWidth,
      })}`,
    ...
    const heightText = new TextInputBuilder({
      custom_id: "height",
      label: `${locale.height}${f(locale.default, {
        value: stableDiffusion._.DefualtHeight,
      })}${f(locale.range, {
        a: stableDiffusion._.MinHeight,
        b: stableDiffusion._.MaxHeight,
      })}`,
      style: TextInputStyle.Short,
      max_length: 5,
    ...
    const batchSizeText = new TextInputBuilder({
      ...
      label: `${locale.batch_size}${f(locale.default, {
        value: stableDiffusion._.DefaultBatchSize,
      })}${f(locale.range, {
        a: stableDiffusion._.MinBatchSize,
        b: stableDiffusion._.MaxBatchSize,
      })}`,
      style: TextInputStyle.Short,
      max_length: 5,
    ...
    const nIterText = new TextInputBuilder({
      custom_id: "n_iter",
      label: `${locale.n_iter}${f(locale.default, {
        value: stableDiffusion._.DefaultNIter,
      })}${f(locale.range, {
        a: stableDiffusion._.MinNIter,
        b: stableDiffusion._.MaxNIter,
      })}`,
      style: TextInputStyle.Short,
      max_length: 4,
    ...
    const seedText = new TextInputBuilder({
      custom_id: "seed",
      label: `${locale.seed}${f(locale.default, {
        value: stableDiffusion._.DefaultSeed,
      })}`,
      style: TextInputStyle.Short,
      max_length: 20,
  ...
  onInteraction: async (interaction: ModalSubmitInteraction) => {
    ...
    if (
      checkIntegerRange(
        ...
        locale,
        locale.width,
        stableDiffusion._.MinWidth,
        stableDiffusion._.MaxWidth,
        width
      )
    )
      return;
    ...
    if (
      checkIntegerRange(
        ...
        locale,
        locale.height,
        stableDiffusion._.MinHeight,
        stableDiffusion._.MaxHeight,
        height
      )
    )
      return;
    const batch_size = Number(
      interaction.fields.getTextInputValue("batch_size")
    );
    if (
      checkIntegerRange(
        interaction,
        locale,
        locale.batch_size,
        stableDiffusion._.MinBatchSize,
        stableDiffusion._.MaxBatchSize,
        batch_size
      )
    )
      return;
    ...
    if (
      checkIntegerRange(
        ...
        locale,
        locale.n_iter,
        stableDiffusion._.MinNIter,
        stableDiffusion._.MaxNIter,
        n_iter
      )
    )
      return;
